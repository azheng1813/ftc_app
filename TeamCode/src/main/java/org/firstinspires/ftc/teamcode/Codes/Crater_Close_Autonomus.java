...
@Autonomous(name = "Crater_Close_Autonomus", group = "FINAL")
@Disabled

public class Crater_Close_Autonomus extends LinearOpMode {
...
class Drive extends LinearOpMode {
    ...
    Crater_Close_Autonomus tensorFlowMineralPosition = new Crater_Close_Autonomus();
    ...
    public void runOpMode() {
        ...
        if(MP == 2){
            ...
            //right 
            encoderDrive(.75, 10, 10, 10, 10, .75);
            encoderDrive(TURN_SPEED, -21, 21, 21, -21, 1.5);
            encoderDrive(.75, 14, 14, 14, 14, .75);
            encoderDrive(DRIVE_SPEED, -8.5, -8.5, -8.5, -8.5, .75);//common
            encoderDrive(TURN_SPEED, 21, -21, 21, -21, 1.5);//common
            encoderDrive(DRIVE_SPEED, 52, 52, 52, 52, 2);
        }
        else if (MP == 1){
            telemetry.addData("center Position","It works!!");
            //center
            encoderDrive(.75, 10, 10, 10, 10, .75);
            encoderDrive(.75, 14, 14, 14, 14, .75);//common
            encoderDrive(DRIVE_SPEED, -8.5, -8.5, -8.5, -8.5, .75);//common
            encoderDrive(TURN_SPEED, 21, -21, 21, -21, 1.5);//common
            encoderDrive(DRIVE_SPEED, 38, 38, 38, 38, 1.75); //center
        }
