...
public class Drive_Test extends LinearOpMode {
    ...
    TensorFlowH tensorFlowMineralPosition = new TensorFlowH();
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,5.0 ,5.0 ,5.0 ,5.0 , 3.0);
        if(MP == 2){
            telemetry.addData("Right Position","It works!!");
            //right 
            encoderDrive(DRIVE_SPEED,5.0 ,5.0 ,5.0 ,5.0 , 10.0);
        }
        else if (MP == 1){
...
class TensorFlowH extends LinearOpMode {
